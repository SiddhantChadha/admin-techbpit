    ...
    <div className="my-12 bg-white mx-5 p-5 rounded-lg shadow-md w-5/12">
      ...
      <div className="flex items-center px-5">
        <div className="flex flex-col p-2 items-center">
          <div className="font-semibold text-primaryBlue">15</div>
          <div className="font-semibold">Jan</div>
        </div>
        <div className="p-3">
          <div className="font-semibold">Online Meeting</div>
          <div className="text-xs text-gray-500">04:09 PM Onwards</div>
        </div>
      </div>
    </div>
  );
